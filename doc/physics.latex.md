...
\vspace{10} \\
0 + ... &=& ... \pm 2 * f * [\overrightarrow{p}_k \times (f * \widehat{n})] \bullet \overrightarrow{\omega}_k + f^2 * [\overrightarrow{p}_k \times \widehat{n}] \bullet (I_k^{-1} * \overrightarrow{p}_k \times \widehat{n})
```